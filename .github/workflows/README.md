...
This is a Roblox Development Tool. NOT a cheat.

This program is a Lua script execution environment built for developers, scripters, and researchers. It is intended solely for use in private servers, solo sessions, or environments where you have explicit permission to run custom scripts.

This tool is NOT designed to grief, exploit, or harm other players. Using it to disrupt others' gameplay, gain unfair advantages in public servers, or violate any game's Terms of Service is strictly prohibited.
